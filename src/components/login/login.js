        ...
        <div>
            ...
            <div className="w-full flex flex-wrap">
                <div className="w-full md:w-1/2 flex flex-col">
                    <div className="flex flex-col justify-center md:justify-start my-auto pt-8 md:pt-0 px-8 md:px-24 lg:px-32 bg-gray-600 m-20">
                        <p className="text-center text-3xl">Welcome.</p>
                        <form className="flex flex-col pt-3 md:pt-8 bg m-4 " onsubmit="event.preventDefault();">
                ...
                <div className="w-1/2 shadow-2xl pt-10 pb-10s">
                    <img className="object-cover rounded-3xl w-full h-screen hidden md:block" alt="" src="./images/socialdistancing.jpg" />
                </div>
            </div>
        </div>
