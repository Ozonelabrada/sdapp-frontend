...
import { findAllViolationType, findOwnViolationType } from "../../api/endpoints/violType.js";
...
const ViolationType = () => {
    ...
    React.useEffect(() => {
        if (['SUPER_ADMIN', 'ADMIN'].includes(user.role)) {
            findAllViolationType().then(setViolations);
            
            toast.success("ADMINS");
        }
        else if (user.role === 'USER'){
            findOwnViolationType().then(setViolations);
            toast.success("USEER");
        }
    }, []);
                        ...
                        <ul className="md:flex-col md:min-w-full flex flex-col list-none">
                            ...
                            <li className="inline-flex">
                                <Link
                                    ...
                                    to="/violation-type"
                                >
                                    <i className="fas fa-paint-brush mr-2 text-blueGray-400 text-base"></i> Violation Type
                                </Link>
                            </li>
                        </ul>
                        {/* Divider */}
                                                                ...
                                                                <tbody className="block md:table-row-group w-full">
                                                                    {/* {(violations.length < 0) && 
                                                                        <div class="bg-red-100 border border-red-400 text-red-700 px-4 py-3 w-full rounded relative" role="alert">
                                                                            ...
                                                                            <span class="block sm:inline">You are not Allowed to View Violation List Module.</span>
                                                        ...
                                                        <div className="w-full bg-gray-500" >
                                                            <div className="container mx-auto py-8">
                                                                <div className="w-5/6 lg:w-3/4 mx-auto bg-white rounded shadow">
                                                                    <div className="py-4 px-8 text-black text-xl border-b border-grey-lighter m-auto">Violation Entry</div>
                                                                    ...
                                                                    <div className="py-4 px-8">
                                                                        <form onSubmit={handleSubmitViol}>
                                                                            ...
                                                                            <div className="flex mb-4">
                                                                                <div className="w-1/2 mr-1">
                                                                                    <label className="block text-grey-darker text-sm font-bold mb-2" htmlFor="type">Violation Type</label>
                                                                                    <input required onChange={setCredentials}
                                                                                        type="text"
                                                                                        name="type_id" className="appearance-none border rounded w-full py-2 px-3 text-grey-darker" placeholder="violation type here" />
                                                                                </div>
                                                                                <div className="w-1/2 ml-1">
                                                                                    <label className="block text-grey-darker text-sm font-bold mb-2" htmlFor="last_name">Description</label>
                                                                                    <textarea required onChange={setCredentials} className="appearance-none border rounded w-full py-2 px-3 text-grey-darker" name="description" type="text" placeholder="description" />
                                                                                </div>
                                                                            </div>
                                                                            <div className="flex mb-4">
                                                                                <div className="w-1/2 mr-1">
                                                                                    <label className="block text-grey-darker text-sm font-bold mb-2" htmlFor="location">Location</label>
                                                                                    <input required onChange={setCredentials} className="appearance-none border rounded w-full py-2 px-3 text-grey-darker" name="location" type="text" placeholder="location here" />
                                                                                </div>
                                                                                <div className="w-1/2 ml-1 hidden">
                                                                                    <label disable="true" className="block text-grey-darker text-sm font-bold mb-2" htmlFor="last_name">Creator </label>
                                                                                    <input onChange={setCredentials} className=" appearance-none border rounded w-full py-2 px-3 text-grey-darker" value={user.id} name="creator_id" type="text" />
                                                                                </div>
                                                                            </div>
                                                                            <div className="flex items-center justify-between m-auto w-80">
