...
export default function Profile() {
    ...
    const handleUpdateUser = (id) => {
        updateUser(id).then((res) => {
            ...
            } else toast.error(' Updating Failed Check Network Connection!')
        });
                    ...
                    <div className="px-4 md:px-10 mx-auto w-full">
                        <div>
                            ...
                            <div className="font-sans antialiased text-gray-900 leading-normal tracking-wider bg-cover background-image:url('https://source.unsplash.com/1L71sPT5XKc');">
                                <div className="max-w-4xl flex items-center lg:h-screen flex-wrap mx-auto lg:my-0">
                                    {/* <!--Main Col--> */}
                                    <div className="w-full lg:w-3/5 rounded-lg lg:rounded-l-lg lg:rounded-r-none shadow-2xl bg-white opacity-75 mx-6 lg:mx-0">
                                        <div className="p-4 md:p-12 text-center lg:text-left">
                                            ...
                                            <div className="pt-12 pb-8">
                                                <button onClick={() => setShowModal(true)} className="bg-green-700 hover:bg-green-900 text-white font-bold py-2 px-4 rounded-full">
                                                    Update Information
                                                </button>
                                            </div>
                                             {showModal ? (
                                                                            ...
                                                                            <form>
                                                                                <div className="flex mb-4">
                                                                                    <div className="mb-4">
                                                                                        ...
                                                                                        <input onChange={setCredentials} className="appearance-none border rounded w-full py-2 px-3 text-grey-darker" value={user.username} name="username" type="text" placeholder="Your username" />
                                                                                    </div>
                                                                                    <div className="w-1/2 mr-1">
                                                                                        <label className="block text-grey-darker text-sm font-bold mb-2" htmlFor="first_name">First Name</label>
                                                                                        <input onChange={setCredentials} type="text" name="first_name" className="appearance-none border rounded w-full py-2 px-3 text-grey-darker" value={user.first_name} placeholder="Your first name" />
                                                                                    </div>
                                                                                    <div className="w-1/2 ml-1">
                                                                                        <label className="block text-grey-darker text-sm font-bold mb-2" htmlFor="last_name">Middle Initial</label>
                                                                                        <input onChange={setCredentials} className="appearance-none border rounded w-full py-2 px-3 text-grey-darker" value={user.middle_name} name="middle_name" type="text" placeholder="Your middle initial" />
                                                                                    </div>
                                                                                </div>
                                                                                <div className="flex mb-4">
                                                                                    <div className="w-1/2 mr-1">
                                                                                        <label className="block text-grey-darker text-sm font-bold mb-2" htmlFor="firstname">Last Name</label>
                                                                                        <input onChange={setCredentials} className="appearance-none border rounded w-full py-2 px-3 text-grey-darker" value={user.last_name} name="last_name" type="text" placeholder="Your last name" />
                                                                                    </div>
                                                                                    <div className="w-1/2 ml-1">
                                                                                        <label
                                                                                ...
                                                                                <div className="mb-4">
                                                                                    ...
                                                                                    <input onChange={setCredentials} className="appearance-none border rounded w-full py-2 px-3 text-grey-darker" value={user.email} name="email" type="email" placeholder="Your email address" />
                                                                                </div>
                                                                                {/* <div className="mb-4">
                                    ...
                                    <div className="w-3/4 lg:w-2/5 bg-white h-auto">
                                        ...
                                        <img className="fill-current rounded-none lg:rounded-lg shadow-2xl hidden lg:block " alt="" src="./images/anonymous.jpg" />
