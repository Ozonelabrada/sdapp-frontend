...
import { getMe } from "../../api/endpoints/user.js";
                                ...
                                {users.length > 0 && (
                                    <div class="max-w-4xl flex items-center lg:h-screen flex-wrap mx-auto lg:my-0">
                                        ...
                                        <div className="w-full lg:w-3/5 rounded-lg lg:rounded-l-lg lg:rounded-r-none shadow-2xl bg-white opacity-75 mx-6 lg:mx-0">
                                            {users.map(user => (
                                                <div class="p-4 md:p-12 text-center lg:text-left">
                                                    ...
                                                    <h1 class="text-3xl font-bold pt-8 lg:pt-0">M{user.username}</h1>
                                        ...
                                        <div class="w-full lg:w-2/5">
                                            ...
                                            <img className="rounded-none lg:rounded-lg shadow-2xl hidden lg:block" alt="" src="https://source.unsplash.com/MP0IUfwrn0A" />
